...
export PATH="$HOME/.rover/bin:/opt/homebrew/opt/postgresql@15/bin:$HOME/code/go/bin:/opt/homebrew/bin:/usr/local/bin:/opt/local/bin:/opt/local/sbin:/usr/local/go/bin:/usr/sbin:/usr/bin:/sbin:/bin:$PATH"
