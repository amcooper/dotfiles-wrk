--[[
  We are if-blocking the entire configuration for the time being, as it was
  causing visual artifacts in VSCode with the Neovim extension enabled.
  Hopefully that will abate once we have the config modularized properly.
--]]
